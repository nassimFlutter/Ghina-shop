class Keys {
  ...
  static const String kIsFirstTime = 'first_time'; // ! this is to know if user enter to app first time .. 
  static const String kIsLogin = 'first_time'; // ! this is to know if user login or register  .. 
}
